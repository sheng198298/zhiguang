...
const createIcon = (path: ReactNode) => (props: IconProps) => (
  <svg
...
export const BookIcon = createIcon(
  <>
    <path d="M12 5.5C10.3 4.2 8.1 3.8 5.5 4v13.4c2.6-.2 4.8.2 6.5 1.5 1.7-1.3 3.9-1.7 6.5-1.5V4c-2.6-.2-4.8.2-6.5 1.5z" />
    <path d="M12 5.5v13.4" />
  </>
);
...
export const HotIcon = createIcon(
  <>
