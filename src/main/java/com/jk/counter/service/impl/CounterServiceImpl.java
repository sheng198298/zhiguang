package com.jk.counter.service.impl;

import com.jk.counter.schema.CounterKeys;
import com.jk.counter.schema.CounterSchema;
import com.jk.counter.schema.BitmapShard;
import com.jk.counter.service.CounterService;
import com.jk.counter.event.CounterEvent;
import com.jk.counter.event.CounterEventProducer;
...
public class CounterServiceImpl implements CounterService {
    ...
    public Map<String, Map<String, Long>> getCountsBatch(String entityType, List<String> entityIds, List<String> metrics) {
        ...
        // 注意：SDS 为二进制固定结构，必须用 ByteArray 序列化器，否则会被 StringRedisTemplate 的
        // StringRedisSerializer 转成 String，导致 instanceof byte[] 判断失败而误补零。
